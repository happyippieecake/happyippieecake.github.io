...
<div class="container mx-auto px-4 lg:px-6">
  ...
  <class=bg-gray-100 py-8>
    <div class="container mx-auto">
      ...
      <div class="flex overflow-x-auto space-x-4 p-4">
        ...
        <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
          <div class="relative">
            <img alt="Mocca Nougat Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 1.jpg" />
          ...
          <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition">Half Cake</h3>
          <div class="mt-2">
            <p class="text-red-600 line-through mb-1">Rp. 250.000</p>
            <p class="text-gray-800 font-bold">Rp. 175.000</p>
          </div>
          <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
        </div>

         <!-- Product 1 -->
         <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
          <div class="relative">
            <img alt="Mocca Nougat Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 5.jpg" />
            <span class="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded shadow animate-pulse">SALE</span>
          </div>
          <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition">CupCakeDecoration </h3>
          <div class="mt-2">
            <p class="text-red-600 line-through mb-1">Rp. 150.000</p>
        ...
        <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
          <div class="relative">
            <img alt="Whole Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 2.jpg" />
            <span class="absolute top-2 right-2 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white text-xs font-bold px-2 py-1 rounded shadow">Hot!</span>
          </div>
          <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition">Whole Cake</h3>
          <div class="mt-2">
            <p class="text-red-600 line-through mb-1">Rp. 350.000</p>
            <p class="text-gray-800 font-bold">Rp. 250.000</p>
          </div>
          <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
          <div class="relative">
            <img alt="Bento Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 3.jpg" />
            <span class="absolute top-2 right-2 bg-gradient-to-r from-green-400 to-green-600 text-white text-xs font-bold px-2 py-1 rounded shadow">New</span>
          </div>
          <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition">Bento Cake</h3>
          <div class="mt-2">
            <p class="text-red-600 line-through mb-1">Rp. 100.000</p>
            <p class="text-gray-800 font-bold">Rp. 60.000</p>
          </div>
          <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
          <div class="relative">
            <img alt="Custom Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 4.jpg" />
            <span class="absolute top-2 right-2 bg-gradient-to-r from-purple-500 to-purple-700 text-white text-xs font-bold px-2 py-1 rounded shadow">Custom</span>
          </div>
          <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition">Custom Cake</h3>
          <div class="mt-2">
            <p class="text-red-600 line-through mb-1">Rp. 240.000</p>
            <p class="text-gray-800 font-bold">Rp. 180.000</p>
          </div>
          <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
        </div>
      ...
      <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
        <div class="relative">
          <img alt="Mocca Nougat Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 6.jpg" />
          <span class="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded shadow animate-pulse">SALE</span>
        </div>
        <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition"> Kue Potong Redvelvet Cheese Frosting</h3>
        <div class="mt-2">
          <p class="text-gray-800 font-bold">Rp. 100.000</p>
        </div>
        <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
    ...
    <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
      <div class="relative">
        <img alt="Mocca Nougat Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 7.jpg" />
        <span class="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded shadow animate-pulse">SALE</span>
      </div>
      <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition"> Kue Potong Matcha Cheese Frosting</h3>
      <div class="mt-2">
        <p class="text-gray-800 font-bold">Rp. 100.000</p>
      </div>
      <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
    ...
    <div class="bg-white shadow-lg rounded-lg p-4 group flex-shrink-0 w-64 transition-transform transform hover:scale-105 hover:shadow-2xl relative">
      <div class="relative">
        <img alt="Custom Cake" class="w-full h-48 object-cover rounded-lg transition-transform transform group-hover:scale-110" src="gambar/cake 8.jpg" />
        <span class="absolute top-2 right-2 bg-gradient-to-r from-purple-500 to-purple-700 text-white text-xs font-bold px-2 py-1 rounded shadow">Custom</span>
      </div>
      <h3 class="text-gray-800 font-semibold mt-4 group-hover:text-pink-500 transition">Fudgy Brownies</h3>
      <div class="mt-2">
        <p class="text-red-600 line-through mb-1">Rp. 220.000</p>
        <p class="text-gray-800 font-bold">Rp. 190.000</p>
      </div>
      <a class="mt-4 block bg-gradient-to-r from-pink-400 to-red-500 text-white text-center py-2 rounded shadow hover:from-pink-600 hover:to-red-600 transition duration-300" href="pesan.html" target="_blank">Pesan Sekarang</a>
    </div>
  </div>
